...
// 志愿场景导航：智能填报为核心入口，其余为知识网络 6+1
const primaryNav: NavItem[] = [
  { key: "match", label: "智能填报", icon: Sparkles },
  { key: "chat", label: "AI 咨询", icon: MessagesSquare },
  { key: "major", label: "专业", icon: GraduationCap },
  { key: "career", label: "行业前景", icon: Briefcase },
  { key: "truth", label: "专业真相", icon: ShieldAlert },
  { key: "idol", label: "偶像对话", icon: Star },
  { key: "rule", label: "规则工具", icon: Scale },
  { key: "case", label: "真实案例", icon: BookOpen },
  { key: "student", label: "我的档案", icon: User },
];
// 收纳进「更多」的次要项
const moreNav: NavItem[] = [
  { key: "network", label: "知识网络", icon: Waypoints },
  { key: "knowledge", label: "知识规则", icon: FileText },
